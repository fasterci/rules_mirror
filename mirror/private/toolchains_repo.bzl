...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@com_fasterci_rules_mirror//mirror:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.mirrorinfo,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@com_fasterci_rules_mirror//mirror:toolchain_type"],
...
# By default all these toolchains are registered by the mirror_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:mirror_toolchain",
    toolchain_type = "@com_fasterci_rules_mirror//mirror:toolchain_type",
)
""".format(
            platform = platform,
