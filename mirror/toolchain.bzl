...
def _mirror_toolchain_impl(ctx):
...
mirror_toolchain = rule(
    implementation = _mirror_toolchain_impl,
    attrs = {
    ...
    doc = """Defines a mirror compiler/runtime toolchain.
